...
dataset2019$regist <- as.factor(dataset2019$regist)
dataset2019$landing_threshould <- as.numeric(dataset2019$landing_threshould)


#--- threshold -------------------------------------------------------

#hist(as.numeric(dataset2019$takeoff_threshould))
# threshould #####
...
#x <- as.data.frame(unique(dataset2019$landing_threshould))
...
save_as_docx("my table" = ft, path = "table_results2019.docx")
